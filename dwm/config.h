...
static Key keys[] = {
    ...
    { MODKEY,              XK_j,            focusstack,       {.i = +1} },               /* super j            |  本tag内窗口 */
/*	  { MODKEY|ShiftMask,    XK_k,            rotatestack,      {.i = -1 } },  */             /* super shift  k     |  本tag内切换聚焦窗口 */
/*   	{ MODKEY|ShiftMask,    XK_j,            rotatestack,      {.i = +1 } },  */            /* super shift  j     |  本tag内切换聚焦窗口 */
 ...
 /*   { MODKEY,              XK_Down,         focusstack,       {.i = +1} },      */         /* super down         |  本tag内切换聚焦窗口 */
    ...
    { MODKEY|ShiftMask,  XK_equal,        setgap,           {.i = -6} },               /* super ctrl +       |  窗口增大 */
    { MODKEY|ShiftMask,  XK_minus,        setgap,           {.i = +6} },               /* super ctrl -       |  窗口减小 */
    { MODKEY|ShiftMask,  XK_space,        setgap,           {.i = 0} },                /* super ctrl space   |  窗口重置 */
    ...
    { MODKEY,              XK_F4,     spawn, SHCMD("pcmanfm") },                                                /* super F1         | 文件管理器             */
    { MODKEY|ShiftMask,    XK_s,      spawn, SHCMD("~/scripts/blurlock.sh") },                                  /* super s          | 锁定屏幕               */
/*    { MODKEY,              XK_F1,     spawn, SHCMD("~/scripts/set_vol.sh up") },  */                              /* super shift up   | 音量加                 */
    { MODKEY,              XK_F2,     spawn, SHCMD("~/scripts/set_vol.sh up") },                               /* super shift up   | 音量加                 */
    { MODKEY,              XK_F3,     spawn, SHCMD("~/scripts/set_vol.sh down") },                             /* super shift down | 音量减                 */
    { MODKEY,              XK_minus,      spawn, SHCMD("flameshot gui -c  -p ~/Pictures/screenshots") },         /* super       -    | 截图                   */
